...
| Document                                      | Purpose                                                                            |
| --------------------------------------------- | ---------------------------------------------------------------------------------- |
| `docs/adr/ADR-001–049`                        | 49 Architecture Decision Records                                                   |
...
_Phase 5 Sprint 4 · 231 suites · 2,858 tests · 90.52% coverage · 49 ADRs · 18 GenAI principles · 25 conformance kits · 19 provider slots_
