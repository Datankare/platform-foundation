...
Supabase (PostgreSQL) with 34 migrations; the foundational set covers: identity and access (001–009), content safety (010–014), social data model (015), and agent runtime (016). Row-level security on all tables. Service-role bypass for server-side agent operations.
