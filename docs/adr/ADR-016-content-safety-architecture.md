...
| Content Rating Filter | User's COPPA content rating level (1/2/3) sets classifier thresholds — stricter for minors                                                                                         | < 1ms     | Zero       | 3     |
...
| `user_content_rating` | User's COPPA tier at time of check                    | 3     |
| `user_strike_count`   | Cumulative strikes at time of check                   | 4     |
...
| COPPA content rating levels (1/2/3)         | Not enforced in safety check — every user gets the same threshold  |
...
| 4     | Appeal workflow — user submits appeal, human reviewer decides                          |
| 5     | User-generated game content screening                                                  |
| 8     | Real-time moderation for real-time live content (sub-100ms)                            |
