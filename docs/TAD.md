...
_Last reviewed: September 2026 (Sprint 5 open — ADR-042 (application-specific RAG) and ADR-043 (UGC input-surface screening) reserved as Proposed and indexed; prior: Sprint 4 close, PF v2.2.0)_
